...
gsap.to("#feuille-1", { x: "110vw", repeat: -1, duration: 5, rotation: 180 }),
  gsap.to("#feuille-2", { x: "150vw", repeat: -1, duration: 5, rotation: 180 }),
  timeline
    .to(".fleche-01", { opacity: 1, duration: 0.5 })
    .to(".fleche-01", { opacity: 0, duration: 0.5, delay: 0.1 }),
  timeline
    .to(".fleche-02", { opacity: 1, duration: 0.5 })
    .to(".fleche-02", { opacity: 0, duration: 0.5, delay: 0.1 }),
  timeline
    .to(".fleche-03", { opacity: 1, duration: 0.5 })
    .to(".fleche-03", { opacity: 0, duration: 0.5, delay: 0.1 });
let chapter1 = gsap
    .timeline({
      scrollTrigger: { scrub: !0, end: "+=12000", pin: !0, trigger: "#chap-1" },
    })
  ...
  chapter3 = gsap
    .timeline({
      scrollTrigger: { scrub: !0, end: "+=12000", pin: !0, trigger: "#chap-3" },
    })
  ...
  chapter4 = gsap
    .timeline({
      scrollTrigger: { scrub: !0, end: "+=8000", pin: !0, trigger: "#chap-4" },
    })
    .to("#transition-slide-1", { x: "-550vw" })
    .to("#cercle-transition-2", { scale: 12, duration: 10 });
gsap.to("#cloud-1", {
  x: "-20vw",
  scrollTrigger: { trigger: "#chap-4", scrub: !0, end: "+=8000" },
}),
  gsap.to("#cloud-2", {
    x: "-20vw",
    scrollTrigger: { trigger: "#chap-4", scrub: !0, end: "+=8000" },
  ...
  gsap.to("#soldat_future", {
    x: "-25vw",
    scrollTrigger: { trigger: "#chap-4", scrub: !0, end: "+=6000" },
  }),
  gsap.to(".jack-4", {
    x: "-25vw",
    scrollTrigger: { trigger: "#chap-4", scrub: !0 },
    end: "+=6000",
  }),
  gsap.to("#ours", {
    x: "-25vw",
  ...
  gsap.to("#cercle", { duration: 2 });
let chapter5 = gsap
    .timeline({
      scrollTrigger: { scrub: !0, end: "+=6000", pin: !0, trigger: "#chap-5" },
    })
    .to("#cercle-transition-2", { scale: 0, duration: 10 }),
  chapter52 = gsap
    .timeline({
    ...
    .to("#grand_pere", { x: "5vw", duration: 5, opacity: 1 }),
  chapter6 = gsap
    .timeline({
      scrollTrigger: { scrub: !0, end: "+=6000", pin: !0, trigger: "#chap-6" },
    })
